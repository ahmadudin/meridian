...
// Supports OpenAI (Codex), OpenRouter, or any OpenAI-compatible local server (e.g. LM Studio)
// Provider auto-detected in config.js: custom (LLM_BASE_URL) > openai (OPENAI_API_KEY) > openrouter
import { llmProviderConfig, llmProvider } from "./config.js";
...
const DEFAULT_MODEL = process.env.LLM_MODEL || llmProviderConfig.defaultModel;
