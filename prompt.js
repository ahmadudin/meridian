...
PAPER MODE RULE: When DRY_RUN=true and paper trading is enabled, deploy_position and close_position are simulated paper actions, not live on-chain transactions. Describe results as simulated paper opens/closes, never as executed on-chain transactions, and never ask for on-chain confirmation.
...
PAPER MODE RULE: When DRY_RUN=true and paper trading is enabled, deploy_position and close_position are simulated paper actions, not live on-chain transactions. Describe results as simulated paper opens/closes, never as executed on-chain transactions, and never ask the user to confirm an on-chain execution.
